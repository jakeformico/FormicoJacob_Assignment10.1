...
//         // Do something based on the state of the subject
//         message = broadcaster.getMessage();
//         try {
//             if (broadcaster.getMessageState().equals("BROADCAST")) {
//                 timeNow = LocalTime.now();
//                 myWriter.append("Got broadcast: " + message + " from " + broadcaster.toString() + " in mode: "
//                         + broadcaster.getMessageState() + " at time: " + dtf.format(timeNow) + "\n");
//             } else if (broadcaster.getMessageState().equals("MESSAGE")
//                     && broadcaster.getMessageGroupNumber() == messageGroup) {
//                 timeNow = LocalTime.now();
//                 myWriter.append("Got message: " + message + " from " + broadcaster.toString() + " in mode: "
//                         + broadcaster.getMessageState() + " at time: " + dtf.format(timeNow) + "\n");
//             } else if (broadcaster.getMessageState().equals("COMMAND")) {
//                 doACommand();
//             } else if (broadcaster.getMessageState().equals("RANDOM")
